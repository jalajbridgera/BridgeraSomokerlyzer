...
@class StepOneViewController;
@class CommunicateDeviceViewController;
/**
...
@interface RIOInterface : NSObject {
	...
	//StepOneViewController *listener;
...
@property(nonatomic, assign) CommunicateDeviceViewController *listener;

@property(assign) float sampleRate;
@property(assign) float frequency;

@property(assign) int totalCount;
@property (assign)int recorderCount;
